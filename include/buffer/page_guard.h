...
namespace bptree {
    ...
    public:
        ...
        PageGuard(BufferPoolManager *bpm, Page *page, LatchMode mode = LatchMode::None);
        ...
        // Release latch and unpin immediately, making this guard empty
        void Drop();
    ...
    private:
        ...
        LatchMode mode_ { LatchMode::None };
    };
